...
export function BatchUploader() {
    ...
    return (
        // Layout: Shifted Left (pl-2 instead of px-6)
        <div className="h-full flex pl-2 pr-6 py-4 gap-6 bg-[#F8FAFC]">

            {/* Left Panel: Controls */}
            <div className="w-[400px] flex flex-col gap-6 h-full overflow-hidden shrink-0">
